...
<div class="container">
    <div class="row">
        <div class="row">
            <div class="col-md-9">
                <h4 class="name"> Related Advertisements </h4>
            </div>
            ...
            <div class="carousel-inner">
                                    ...
                                    <div class="info">
                                        <div class="row">
                                            <div class="price col-md-12">
                                                ...
                                                <h6 class="price-text-color">Rs : <?php echo field_by_ad_id('price',$row['tbl_name'],$row['id']);?></h6>
                                            </div>
                ...
                <div class="item">
                    <div class="row">
                        ...
                        <?php
                        $q="select * from all_ads where main_cat_id=1 ORDER BY RAND() LIMIT 4;";
                        $result=mysqli_query(DBConnection(),$q);
                        $ads=array();
