...
<head>
    ...
    <title>Aladinlk.com offer a property for rent</title>
    <meta name="theme-color" content="#e2a01a">
...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="col-md-12 col-md-offset-0">
                ...
                <h4 class="text-center text-warning headtext" style="margin-top:15px;margin-bottom:15px;">Let's Post Your Advertisement .Please Fill All Details Of Your Property.</h4>
            </div>
            <br>
            <div class="col-md-12">
                        ...
                        <div class="panel-body post-panal pointer" data-target="#area" data-toggle="modal">
                            ...
                            if(isset($_SESSION['sub_area_id'])){
                                ...
                                if ($row=mysqli_fetch_assoc($result)){
                                    echo  "<h4 class='text-warning' style='text-align: center'>".$row['sub_area_name']."</h4>";
                                }
                                mysqli_close(DBConnection());
                            }
                            else{
                                echo  "<h4 class='text-warning' style='text-align: center'>Select Area</h4>";
                            }
    ...
    <div class="post-ad-content">
        ...
        if(isset($_SESSION['sub_area_id'])){
            ...
            $sql = "UPDATE advertisement SET sub_cat_id=99, sub_area_id={$_SESSION['sub_area_id']} WHERE id={$_SESSION['ad_id']}";

            if(mysqli_query(DBConnection(), $sql)){
                $_SESSION['sub_cat_id']=99;
                //load view
                $sub_cat= select_by_id(99,'Tbl_name','sub_category');
                include 'include/post_your_ad/'.$sub_cat.'.php';
