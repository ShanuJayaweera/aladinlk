...
if(isset($_POST['default_only_type'])){
    ...
    if(empty($errors)){
        ...
        if (DB_insert($customer_details)==true){
            ...
            $default="INSERT INTO default_only_type (ad_id, type_name, title, description, price, image_path) 
                      VALUES (".$_SESSION['ad_id'].", '".$type_name."', '".$title."', '".$description."', '".$price."', '".$image_path."');";


            if(DB_insert($default)==true){
