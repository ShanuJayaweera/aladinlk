    ...
    if(isset($_POST['heavy'])){
        ...
        if (empty($errors)){
            ...
            if (DB_insert($customer_details)==true){
                ...
                $heavy="INSERT INTO heavy (ad_id, title, vehicle_condition, model_year, description, price, image_path,brand) 
                        VALUES (".$_SESSION['ad_id'].", '".$title."', '".$condition."', '".$model_year."', '".$description."', '".$price."', '".$image_path."','".$_POST['brand']."');";


                if(DB_insert($heavy)==true){
