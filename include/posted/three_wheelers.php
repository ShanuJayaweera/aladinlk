    ...
    if(isset($_POST['three_wheel'])){
        ...
        if(empty($errors)){
            ...
            if (DB_insert($customer_details)==true){
                ...
                $three_wheeler="INSERT INTO three_wheelers (ad_id, title, brand, model_year, vehicle_condition, mileage, description, price, image_path) 
                                VALUES (".$_SESSION['ad_id'].", '".$title."', '".$brand."', '".$model_year."', '".$condition."', '".$mileage."', '".$description."', '".$price."', '".$image_path."');";


                if(DB_insert($three_wheeler)==true){
