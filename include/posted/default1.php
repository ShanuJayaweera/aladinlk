...
if(isset($_POST['default'])){
    ...
    if(empty($errors)){
        ...
        if (DB_insert($customer_details)==true){
            ...
            $default="INSERT INTO default1 (ad_id, item_condition, title, description, price, image_path) 
                      VALUES (".$_SESSION['ad_id'].", '".$condition."', '".$title."', '".$description."', '".$price."', '".$image_path."');";
