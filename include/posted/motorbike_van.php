    ...
    if(isset($_POST['motorbike'])){
        ...
        if(!empty($errors)){
            ...
            if (DB_insert($customer_details)==true){
                $motorbike_van="INSERT INTO motorbike_van 
                            (ad_id, brand, model, model_year, vehicle_condition, mileage, engine_capacity, description, price, image_path)
                             VALUES (".$_SESSION['ad_id'].", '$brand', '".$model."', '".$model_year."', '".$condition."', '".$mileage."', 
                             '".$cc."', '".$description."', '".$price."', '".$image_path."');";
                if(DB_insert($motorbike_van)==true){
