    ...
    if(isset($_POST['push'])){
        ...
        if(empty($errors)){
            ...
            if (DB_insert($customer_details)==true){
                $push_auto="INSERT INTO push_auto (ad_id, title, vehicle_condition, description, price, image_path) VALUES
                            (".$_SESSION['ad_id'].", '".$title."', '".$condition."', '".$description."', '".$price."', '".$image_path."');";

                if(DB_insert($push_auto)==true){
