...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="include/posted/default_type_brand.php">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <button class="btn btn-default" type="submit" name="default_type_brand">POST YOUR AD</button>
                    </div>
                </div>
