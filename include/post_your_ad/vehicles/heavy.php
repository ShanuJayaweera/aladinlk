...
<div class="panel">
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="include/posted/heavy.php">
                    <div class="col-md-12">


                                <h4>Fill Your Heavy Machinery or Tractors Details</h4>
                                <hr class="Line">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="checkbox">
                                        <label class="control-label lable">
                                            <input type="checkbox" class="negotiable" name="negotiable"> Negotiable</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button class="btn btn-default" type="submit" name="heavy">POST YOUR AD</button>
                                </div>
                            </div>
