...
?>
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="include/posted/motorbike_van.php">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button class="btn btn-default" type="submit" name="motorbike">POST YOUR AD</button>
                                </div>
                            </div>
