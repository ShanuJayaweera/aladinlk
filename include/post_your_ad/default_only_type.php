...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="include/posted/default_only_type.php">
            <h4>Fill in the Details.  (<?php echo  $_SESSION['ad_type']; ?>)</h4>
            <hr class="Line">
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <button class="btn btn-default" type="submit" name="default_only_type">POST YOUR AD</button>
                    </div>
                </div>
