...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="include/posted/land.php">
            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="land_address" placeholder="Location (Address)" maxlength="200" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <button class="btn btn-default" type="submit" name="land">POST YOUR AD</button>
                    </div>
                </div>
