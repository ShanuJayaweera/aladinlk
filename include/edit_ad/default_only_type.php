...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="include/edited/default_only_type.php">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <button class="btn btn-default" type="submit" name="default_only_type">UPDATE YOUR AD</button>
                    </div>
                </div>
