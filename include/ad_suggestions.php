...
$main_cat_id=main_cat_id_from_ad_id($ad_id);
$ad_count=false;

$query="select count(title) as count from all_ads where main_cat_id=".$main_cat_id.";";
...
<div class="container">
    <div class="row">
        <div class="row">
            <div class="col-md-9">
                <h4 class="name"> More Advertisements </h4>
            </div>
        ...
        <div id="carousel-example" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    $q="select * from all_ads where main_cat_id=".$main_cat_id." ORDER BY RAND() LIMIT 4;";
                }
                                    ...
                                    <div class="col-item">
                                        ...
                                        <div class="info">
                                            <div class="row">
                                                <div class="price col-md-12">
                                                    <h5 style="color: #e2a01a;"><?php echo $row['title'];?></h5>
                                                    <h5 style="color: black;" class="price-text-color">Rs : <?php echo field_by_ad_id('price',$row['tbl_name'],$row['id']);?></h5>
                                                </div>
