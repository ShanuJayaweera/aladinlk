...
try{
    ...
    if(isset($_POST['other'])){
        ...
        if(data_availability('other','ad_id','ad_id',$ad_id)==false){
            $errors[]="Wrong Ad ID";
        }
        ...
        if (empty($errors)){
            ...
            $other="update other set title='".$title."',description='".$description."',price='".$price."',image_path='".$image_path."' where ad_id=".$ad_id.";";

            mysqli_query(DBConnection(), $other);
            mysqli_close(DBConnection());
